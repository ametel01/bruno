...
const PREVIEW_MODES = Object.freeze(['source', 'component']);
const STYLE_MODES = Object.freeze(['scoped', 'astro-global-prefixed']);
const COMMENT_SYNTAXES = Object.freeze(['html', 'jsx']);
const INJECT_KINDS = Object.freeze(['adapter', 'tag']);
