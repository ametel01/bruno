...
| 2. Replace the Basic-auth shell with Clerk-capable routing and UI | #233 | Ready | None | Not opened | Not collected | Not collected | Implement Clerk UI and the Next.js 16 `proxy.ts` route matrix while retaining the Basic operator barrier through Step 9. Coordinate the session-mode seam with Step 3. |
...
- Steps 2 and 3 are the next independent authentication implementation streams.
