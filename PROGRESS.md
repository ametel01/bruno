...
Step 6 is independently accepted through cycle 2 at `fa677fb`. The checker
verified the full missing/FIFO/symlink/hardlink/oversize/malformed/regular
credential-file matrix, 4 files / 77 focused tests, 108 files / 996 full tests,
local fake-boundary smoke, production build, 14 E2E tests, and fail-closed
staging with no side effects. Step 7 durable create-to-ready reconciliation is
now active.
