  ...
  it("drives both explicit human attestations and reports only sanitized final evidence", async () => {
    ...
    const makeRun = (overrides: Record<string, unknown>) => ({
      ...
      nextAction: {
        ...
        text: `Bruno.Ai Hermes initial acceptance ${initialChallengeId}`,
        purpose: "initial",
    ...
    const responses = [
      ...
      makeRun({
        ...
        nextAction: {
          ...
          text: `Bruno.Ai Hermes post-restart acceptance ${restartChallengeId}`,
    ...
    const responses = [
      {
        ...
        nextAction: {
          kind: "operator_telegram",
          challengeId,
          text: `Bruno.Ai Hermes initial acceptance ${challengeId}`,
          purpose: "initial",
          expiresAt: "2030-01-01T00:05:00.000Z",
        },
        checks,
