...
CREATE UNIQUE INDEX "founder_trusted_preview_invitations_slot_idx" ON "founder_trusted_preview_invitations" USING btree ("cohort_slot") WHERE "founder_trusted_preview_invitations"."status" <> 'revoked';--> statement-breakpoint
...
CREATE UNIQUE INDEX "founder_trusted_preview_invitations_clerk_subject_idx" ON "founder_trusted_preview_invitations" USING btree ("invited_clerk_subject_digest") WHERE "founder_trusted_preview_invitations"."status" <> 'revoked';--> statement-breakpoint
