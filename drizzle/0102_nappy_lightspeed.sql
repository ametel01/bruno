ALTER TYPE "public"."founder_product_contract_scenario" ADD VALUE 'external_beta_cohort_lifecycle' BEFORE 'product_entitlement_lifecycle';--> statement-breakpoint
