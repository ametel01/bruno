...
ALTER TABLE "runners" ADD CONSTRAINT "runners_provisioning_operation_key_check" CHECK ("runners"."provisioning_operation_key" IS NULL OR ("runners"."kind" = 'digitalocean' AND "runners"."provisioning_operation_key" ~ '^agentbay-deploy-[0-9a-f]{32}$'));
