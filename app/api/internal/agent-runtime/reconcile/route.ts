import { reconcileNextAgentRuntime } from "@/src/server/agents/agent-runtime-reconciler";
...
type CronRouteDependencies = {
  ...
  reconcile?: typeof reconcileNextAgentRuntime;
};
...
export async function GET(
  ...
  try {
    const result = await (dependencies.reconcile ?? reconcileNextAgentRuntime)();
