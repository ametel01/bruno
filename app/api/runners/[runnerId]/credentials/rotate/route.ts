...
export async function POST(
  ...
  try {
    ...
    const result = await rotateRunnerCredentialForUser(applicationUser.userId, {
    ...
    if (error instanceof RunnerCredentialLifecyclePersistenceError) {
      return lifecyclePersistenceErrorResponse("runner_credential_rotate_failed");
    }
...
function lifecyclePersistenceErrorResponse(code: "runner_credential_rotate_failed") {
  return Response.json(
    {
      ok: false,
      error: {
