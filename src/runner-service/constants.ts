...
export const DEFAULT_HERMES_PRIVATE_NETWORK = "bruno-hermes";
...
export const DEFAULT_HERMES_STATE_ROOT = "/var/lib/bruno/agents";
export const DEFAULT_RUNNER_BOOT_SELF_TEST_ROOT = "/var/lib/bruno/boot-self-test";
export const RUNNER_BOOT_MODEL_CANARY_ENABLED_ENV = "BRUNO_RUNNER_BOOT_MODEL_CANARY_ENABLED";
