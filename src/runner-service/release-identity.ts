...
export const RUNNER_EXPECTED_RELEASE_VERSION_ENV = "BRUNO_RUNNER_EXPECTED_RELEASE_VERSION";
export const RUNNER_EXPECTED_IMAGE_DIGEST_ENV = "BRUNO_RUNNER_EXPECTED_IMAGE_DIGEST";
export const RUNNER_EXPECTED_BOOT_CONTRACT_VERSION_ENV =
  "BRUNO_RUNNER_EXPECTED_BOOT_CONTRACT_VERSION";
export const RUNNER_RELEASE_IDENTITY_MODE_ENV = "BRUNO_RUNNER_RELEASE_IDENTITY_MODE";
export const RUNNER_CONTAINER_ID_ENV = "BRUNO_RUNNER_CONTAINER_ID";
