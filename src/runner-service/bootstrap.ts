...
type RunnerBootstrapEnv = {
  ...
  BRUNO_RUNNER_BOOT_VALIDATION_MODE?: string;
  BRUNO_RUNNER_RELEASE_BUNDLE?: string;
  BRUNO_RUNNER_APPROVED_RELEASE_DIGEST?: string;
  BRUNO_RUNNER_RELEASE_TRUST_SET?: string;
  BRUNO_RUNNER_APPROVED_SNAPSHOT_OCI?: string;
  BRUNO_RUNNER_APPROVED_SNAPSHOT_BUNDLE_DIGEST?: string;
