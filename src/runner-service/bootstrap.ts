...
type RunnerBootstrapEnv = {
  ...
  AGENTBAY_RUNNER_BOOT_VALIDATION_MODE?: string;
  AGENTBAY_RUNNER_RELEASE_ATTESTATION_B64?: string;
  AGENTBAY_RUNNER_RELEASE_ATTESTATION_SIGNATURE?: string;
  AGENTBAY_RUNNER_RELEASE_ATTESTATION_PUBLIC_KEY_B64?: string;
  AGENTBAY_RUNNER_SNAPSHOT_ID?: string;
  AGENTBAY_RUNNER_SNAPSHOT_MANIFEST_DIGEST?: string;
  AGENTBAY_RUNNER_SNAPSHOT_EXPIRES_AT?: string;
  AGENTBAY_RELEASE_SOURCE_REVISION?: string;
};
